...
class marPy:
    ...
    def get_MAR(self):
        ...
        try:
            ...
            self.address_id = 'non_dc_val'
            self.marid = 'non_dc_val'
            self.status = 'non_dc_val'
            self.fulladdress = 'non_dc_val'
            self.addrnum = 'non_dc_val'
            self.addrnumsuffix = 'non_dc_val'
            self.stname = 'non_dc_val'
            self.street_type = 'non_dc_val'
            self.quadrant = 'non_dc_val'
            self.city = 'non_dc_val'
            self.state = 'non_dc_val'
            self.xcoord = 'non_dc_val'
            self.ycoord = 'non_dc_val'
            self.ssl = 'non_dc_val'
            self.anc = 'non_dc_val'
            self.psa = 'non_dc_val'
            self.ward = 'non_dc_val'
            self.nbhd_action = 'non_dc_val'
            self.cluster_ = 'non_dc_val'
            self.poldist = 'non_dc_val'
            self.roc = 'non_dc_val'
            self.census_tract = 'non_dc_val'
            self.vote_prcnct = 'non_dc_val'
            self.smd = 'non_dc_val'
            self.zipcode = 'non_dc_val'
            self.nationalgrid = 'non_dc_val'
            self.roadwaysegid = 'non_dc_val'
            self.focus_improvement_area = 'non_dc_val'
            self.has_alias = 'non_dc_val'
            self.has_condo_unit = 'non_dc_val'
            self.has_res_unit = 'non_dc_val'
            self.has_ssl = 'non_dc_val'
            self.latitude = 'non_dc_val'
            self.longitude = 'non_dc_val'
            self.streetviewurl = 'non_dc_val'
            self.res_type = 'non_dc_val'
            self.ward_2002 = 'non_dc_val'
            self.ward_2012 = 'non_dc_val'
            self.anc_2002 = 'non_dc_val'
            self.anc_2012 = 'non_dc_val'
            self.smd_2002 = 'non_dc_val'
            self.smd_2012 = 'non_dc_val'
            self.imageurl = 'non_dc_val'
            self.imagedir = 'non_dc_val'
